...
export const Hero = () => {
  return (
    <div className="relative w-full md:h-[95vh] h-[50vh] hero-h">
      ...
      <Fade left>
        <div className="text-center lg:w-[70%] w-[90%] mx-[auto] md:py-[154px] md:px-[64px] py-[1.5rem] px-[16px]">
          ...
          <p className="md:text-[26px] md:leading-[141%] text-white mt-[1rem] md:w-[80%] mx-[auto]">
            Flourish Advanced Care is rooted in the mission to deliver care with
            integrity and compassion. Our team is carefully selected and trained
            to match the needs of our clients with the utmost respect and
            professionalism.
          </p>

    ...
    <div className="relative w-full md:h-[670px] h-[60vh]">
      ...
      <div className="md:w-[670px] md:py-[104px] md:px-[64px] py-[1.5rem] px-[16px]">
        <p className="text-white md:text-[22px]">
          ...
          individual&apos;s needs and routines. We&apos;ll make care plans with
          service users in charge and involved (or their appointed
          ...
          daily routines will be monitored to limit and/or manage changes within
          each period of care. We&apos;ll protect the person&apos;s dignity and
          worth.
        </p>
      </div>
    </div>

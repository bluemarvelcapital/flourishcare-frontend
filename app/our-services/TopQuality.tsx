      ...
      <div className="grid xxl:grid-cols-3 md:grid-cols-2 md-grid-cols-1 md:gap-[32px] gap-[16px] items-stretch">
        <div className="h-full">
          ...
          <div className="md:h-[255px] p-[24px] border-[1px] border-[#D3D3D3]">
            ...
            <p>
              Our home care service assists with bathing, dressing, and bedtime.
              We tailor a Personal Care plan to your needs and preferences,
              whether it&apos;s personal cleanlines or catheter changes. Our
              professionally trained Care Workers always provide compassionate,
        ...
        <div className="h-full">
          ...
          <div className="md:h-[255px] p-[24px] border-[1px] border-[#D3D3D3]">
            ...
            <p>
              ...
              carer takes regular breaks from the individual they regularly care
              for. The care is still delivered in the individual&apos;s
        ...
        <div className="h-full">
          ...
          <div className="md:h-[255px] p-[24px] border-[1px] border-[#D3D3D3]">
            ...
            <p>
              Companion care is different for each person. We can help you find
              someone to hang out with at home or to go out with. Companion care
              is based on your needs and where you are in life. For example,
              hobbies and activities, social events, running errands, managing
              household tasks, etc.
            </p>
          </div>
        </div>
        ...
        <div className="h-full">
          ...
          <div className="md:h-[255px] p-[24px] border-[1px] border-[#D3D3D3]">
            ...
            <p>
              ...
              plan. Our crew is trained to recognise mood and behaviour changes
              and respond quickly to alleviate discomfort
            </p>
          </div>
        </div>

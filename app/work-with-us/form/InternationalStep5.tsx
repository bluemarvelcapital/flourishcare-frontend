          ...
          <div className="py-10 px-6 bg-white transition-all">
            <section>
              ...
              <div className="my-10">
                ...
                <p className="md:text-lg">
                  To help us ensure that our Equal Opportunities Policy is fully
                  and fairly implemented please COMPLETE THIS SECTION OF THE
                  APPLICATION FORM.
                </p>
              </div>
              ...
              <div className="my-10">
                ...
                <p className="md:text-lg">
                  Choose ONE section from A to E, and then tick the appropriate
              ...
              <div className="my-10">
                ...
                <p className="md:text-lg">
                  ...
                  following original documents with you if invited to interview:
                  a passport or an immigration and nationality directorate
                  application registration card which evidence the right to work
                  in the UK or a UK residence permit issued to an EEA national
                  which confirms right of entry to or residence in the UK.
                </p>
              </div>

      ...
      <section>
        <div>
          ...
          <p className="md:text-lg">
            This sheet will be separated from your application form upon receipt
            and does not form part of the selection process. It will be retained
            by Human Resources purely for monitoring purposes.
          </p>
        </div>
        ...
        <div className="my-10">
          ...
          <p className="md:text-lg">
            Choose ONE section from A to E, and then tick the appropriate box to
            ...
            <Form.Item className="font-semibold mt-3">
              <Radio.Group>
                <Space direction="vertical">
                  ...
                  <Radio value={"any_white"}>Any other white background</Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
          </div>
            ...
            <Form.Item className="font-semibold mt-3">
              <Radio.Group>
                <Space direction="vertical">
                  ...
                  <Radio value={"aby_black"}>Any other Black background</Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
          </div>
            ...
            <Form.Item className="font-semibold mt-3">
              <Radio.Group>
                <Space direction="vertical">
                  ...
                  <Radio value={"any_mixed"}>Any other mixed background</Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
          </div>
            ...
            <Form.Item className="font-semibold mt-3">
              <Radio.Group>
                <Space direction="vertical">
                  ...
                  <Radio value={"any_asian"}>Any other Asian background</Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
          </div>
        ...
        <div className="my-10">
          ...
          <p className="md:text-lg">
            ...
            an immigration and nationality directorate application registration
            card which evidence the right to work in the UK or a UK residence
            permit issued to an EEA national which confirms right of entry to or
            residence in the UK.
          </p>
        </div>

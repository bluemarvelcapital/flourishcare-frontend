...
export const Hero = () => {
  return (
    <div className="relative w-full md:h-[55vh] h-[60vh] hero-h font-myriad-pro flex justify-center items-center flex-col">
      <div>
        ...
        <Fade left>
          <div className="text-center md:w-[100%] w-[100%] mx-[auto] md:py-[154px] md:px-[64px] py-[1.5rem] px-[16px]">

...
export const InternationalStep4: FC<{ next: () => void }> = ({ next }) => {
  return (
      ...
      <Form layout="vertical" onFinish={next}>
        ...
        <section>
          ...
          <p className="md:text-lg">
            ...
            entered into is subject to documentary evidence of my right to work
            in the UK and satisfactory references. I expressly consent to
            personal data contained within this form being recorded for the
            purposes of assessing suitability for the post and may form the
            basis of any subsequent personnel file.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-5">
            <Form.Item
          ...
          <div>
            <p className="md:text-lg">
              ...
              personal information that you provide to us, or that we obtain
              from you, in accordance with the requirements of the Data
              Protection Act 1998. After initial assessment, Flourish Advanced
              Care Limited may keep your details on file for opportunities that
              may arise in the future. Please tick if you do not wish us to hold
              your details.
            </p>

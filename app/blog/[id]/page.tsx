...
const BlogPostPage = () => {
  ...
  return (
    <div>
      ...
      {postToShow && (
        <div
          className="container_xl w-full md:w-[75%] md:mx-auto"
          style={{
            marginTop: "5rem",
            marginBottom: "5rem",
            maxWidth: "1200px",
        ...
        >
          <div
            className="md:px-[2rem] px-[1.5rem] relative wf-full"
            style={{
              alignItems: "center",
            }}
          >
            <div
              className="relative w-full h-[584px] rounded-t-xxl overflow-hidden"
              style={{ margin: "0 auto" }}
            >
              <Image
                src={postToShow.cover_image}
                alt={postToShow.title}
                fill
                className="w-full h-[584px] object-cover rounded-t-xxl"
                style={{
            ...
            <div
              className="md:px-[40px] md:py-[38px] p-[24px]"
              dangerouslySetInnerHTML={{
                __html: DomPurify.sanitize(postToShow.content),
              }}
            ></div>
          </div>
